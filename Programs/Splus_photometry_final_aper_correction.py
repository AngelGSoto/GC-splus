    ...
    def process_field(self, field_name):
        ...
        for filter_name in self.filters:
            ...
            try:
                ...
                # ¡IMPORTANTE! No aplicar sustracción de fondo adicional
                # Las imágenes ya tienen el fondo sustraído
                data_bg_subtracted = data
                
                # Estimar el ruido de fondo usando sigma-clipped stats
                ...
                for aperture_size in self.apertures:
                    ...
                    # Calculate flux (already background subtracted)
