...
#+BEGIN_QUOTE
Nota clave para el paper: Los offsets grandes en F410 (+0.803 mag) son consistentes con diferencias esperadas entre sistemas fotométricos y no afectan la utilidad científica de la homogenización para SED fitting.
#+END_QUOTE
