...
- I have problem (I think) to do the
  ...
  offset between the my mesauremnets (SPLUS narrow band filters)
  ...
  becouse the phothometri between the filter should
  be homogeneus for GC. So I do again all
  without aperture phothometry. Here the scripts
  withou to aperture correction part.

** Final aproach

I decided to apply de unsharc masking and aperture correctio
similar to Buzzeo et al. 2022. Here the texto:
