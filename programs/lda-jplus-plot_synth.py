...
# XX_neww, y_neww = sm.fit_sample(XX, m1.ravel())
...
ax1.scatter(ld1[1], ld2[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', alpha=0.8, edgecolor='black', zorder=134.0, label='Obs. hPNe')
...
ax2.scatter(ld1[1], ld3[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', alpha=0.8, edgecolor='black', zorder=134.0, label='Obs. hPNe')
