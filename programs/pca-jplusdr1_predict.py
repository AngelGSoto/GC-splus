'''
Principal component analysis (J-PLUS)---Predicting
'''
...
for label_Pro, label_Nu in zip(label_pro, range(8)):
...
select(0.0, "PN-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(1.0, "SySt-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(2.0, "CV-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(3.0, "HII-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(4.0, "QSO-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(5.0, "YSO-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
#select(6.0, "WD-pc-03-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
select(6.0, "SFG-pc-{}-candidate.tab".format(File_name.split('r_')[-1].split('.tab')[0]))
