...
for file_name1 in file_list1:
    ...
    if da['id'].endswith("12636-DR1jplus"):
        label_dr1.append("LEDA 101538")
    if da['id'].startswith("18242-DR1jplus"):
        label_dr1.append("PN Sp 4-1")
...
classifier = LogisticRegression(solver='lbfgs', max_iter = 4000, multi_class='multinomial')
...
for a, b, c in zip(label_dr1, y_pred, y_prob):
    print(a, b, c)
