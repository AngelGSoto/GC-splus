...
# pc1[11].append(XX_pca[m == 11, 0])
# pc2[11].append(XX_pca[m == 11, 1])
# pc3[11].append(XX_pca[m == 11, 2])
...
ax1.scatter(pc1[1], pc2[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', alpha=0.3, edgecolor='black', zorder=120.0, label='Obs. hPNe')
ax1.scatter(pc1[3], pc2[3], c=sns.xkcd_rgb['pale yellow'], alpha=0.3, s=90, marker='o', edgecolor='black', zorder=3.0, label='SDSS CVs')
ax1.scatter(pc1[5], pc2[5],  c= "mediumaquamarine", alpha=0.3, s=90, edgecolor='black',  marker='D', label='SDSS QSOs')
ax1.scatter(pc1[10], pc2[10],  c= "goldenrod", alpha=0.3, s=120, marker='^', edgecolor='black', label='SDSS SFGs')
ax1.scatter(pc1[2], pc2[2],  c= "red", alpha=0.3, s=90, marker='s', edgecolor='black', zorder=3.0, label='Obs SySt')
#ax1.scatter(pc1[3], pc2[3],  c= "red", alpha=0.8, s=120, marker='^', edgecolor='black', zorder=3.0, label='IPHAS SySt')
ax1.scatter(pc1[4], pc2[4],  c= "gray", alpha=0.3, s=90, marker='D', edgecolor='black',  label='Obs. HII regions in NGC 55')
ax1.scatter(pc1[6], pc2[6],  c= "lightsalmon", alpha=0.3, s=150, marker='*', edgecolor='black', label='Obs. YSOs')
ax1.scatter(pc1[9], pc2[9], c= sns.xkcd_rgb["mint green"], alpha=0.3, s=150, marker='*', edgecolor='black', zorder= 125, label='S-PLUS DR1 WDs')
ax1.scatter(pc1[7], pc2[7],  c= sns.xkcd_rgb["cerulean"],  s=700, marker='*', edgecolor='black', zorder= 126, label='Sources selected in J-PLUS DR1')
ax1.scatter(pc1[8], pc2[8],  c= sns.xkcd_rgb["light green"], s=700, marker='*', edgecolor='black', zorder= 126, label='HASH sources in J/S-PLUS DR1')
...
for x,y in zip(pc1[7], pc2[7]):
    ax1.annotate("2", (x[0], y[0]), alpha=9,  size=21, #PN
                   xytext=(-8.0, 7.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)
    ax1.annotate("3", (x[1], y[1]), alpha=9, size=21, # LEDA 101538
                   xytext=(15.0, -35.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)
    ...
    ax1.annotate("4", (x[3], y[3]), alpha=9, size=21, #2790884
                   xytext=(-8.0, -35.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)
for aa, bb in zip(pc1[7], pc2[7]):
...
ax2.scatter(pc1[1], pc3[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', edgecolor='black', alpha=0.3, zorder=120.0, label='Obs. halo PNe')
ax2.scatter(pc1[3], pc3[3],  c = sns.xkcd_rgb['pale yellow'], alpha=0.3, s=90, marker='o', edgecolor='black',zorder=3.0, label='SDSS CVs')
ax2.scatter(pc1[5], pc3[5],  c = "mediumaquamarine", alpha=0.3, s=60,  edgecolor='black', marker='D', label='SDSS QSOs')
ax2.scatter(pc1[10], pc3[10],  c = "goldenrod", alpha=0.3, s=120, marker='^', edgecolor='black', label='SDSS SFGs')
ax2.scatter(pc1[2], pc3[2],  c = "red", alpha=0.3, s=90, marker='s',edgecolor='black', zorder=3.0, label='Obs SySt')
#ax2.scatter(pc1[3], pc3[3],  c = "red", alpha=0.8, s=120, marker='^', edgecolor='black', zorder=3.0, label='IPHAS SySt')
ax2.scatter(pc1[4], pc3[4],  c = "gray", alpha=0.3, s=90, marker='D', edgecolor='black', label='Obs. HII regions in NGC 55')
ax2.scatter(pc1[6], pc3[6],  c = "lightsalmon", alpha=0.3, s=150, marker='*', edgecolor='black', zorder = 11, label='Obs. YSOs')
ax2.scatter(pc1[9], pc3[9], c= sns.xkcd_rgb["mint green"], alpha=0.3, s=150, marker='*', edgecolor='black', zorder= 125, label='S-PLUS DR1 WDs')
ax2.scatter(pc1[7], pc3[7],  c = sns.xkcd_rgb["cerulean"], s=700, marker='*', edgecolor='black', zorder= 126, label='Obs. select in J-PLUS DR1')
ax2.scatter(pc1[8], pc3[8],  c= sns.xkcd_rgb["light green"],  s=700, marker='*', edgecolor='black', zorder= 126, label='HASH sources in J/S-PLUS DR1')


ax2.minorticks_on()

for x,y in zip(pc1[7], pc3[7]):
    ...
    ax2.annotate("1", (x[2], y[2]), alpha=9, size=21,
                   xytext=(3.0, -35.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=180, weight='bold',)
    ax2.annotate("4", (x[3], y[3]), alpha=9, size=21,
                   xytext=(5.0, 15.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)

for aa, bb in zip(pc1[7], pc3[7]):
    for a, b, c in zip(label_dr1, aa, bb):
        print(a,b,c)
...
ax22.scatter(pc2[11], pc3[11],  c = "goldenrod", alpha=0.8, s=120, marker='^', edgecolor='black', label='SDSS SFGs')
