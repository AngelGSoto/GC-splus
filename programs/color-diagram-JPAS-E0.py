...
def plot_mag(f1, f2, f3):
    ...
    x33, y33 = filter_mag("-sys-Ext", '', f1, f2, f3)
    for a, b in zip(x, y):
        d_644.append(a)
        d_768.append(b)
...
ax1.scatter(d_768_Extsys, d_644_Extsys,  c= "red", alpha=0.8, marker='D', label='Extragalactic symbiotics')
...
ax1.text(0.05, 0.95, 'Extinction, E0',
...
plt.tight_layout()
plt.savefig('diagram-JPAS-E0.pdf')
...
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('diagram-JPAS-Jv0915_6600-E0.pdf')
