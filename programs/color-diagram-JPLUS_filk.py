...
from magnitude_utils import calculate_color_differences_simple
...
def filter_mag(e, f1, f2, f3):
    ...
    This version doesn't check the starting string.
    """
    return calculate_color_differences_simple(data, e, f1, f2, f3)
