...
pattern1 = "*-nolda/*-JPLUS17-magnitude.json"
...
file_list2 = file_list + file_list1

shape = (len(file_list2), 12)
shape1 = (len(file_list2), 13)
...
for file_name in file_list2:
    ...
    #     target.append(9)
        ...
        target.append(5)
    elif data["id"].endswith("DR1jplus"): #8
        target.append(0)
    elif data["id"].endswith("DR1SplusWDs"):
        target.append(6)
    elif data["id"].endswith("DR1jplusHash"): #9
        target.append(6)
    else:
        target.append(7) #10
...
ld3[2].append(XX_lda[m1 == 2, 2])
ld1[3].append(XX_lda[m1 == 3, 0])
ld2[3].append(XX_lda[m1 == 3, 1])
ld3[3].append(XX_lda[m1 == 3, 2])
ld1[4].append(XX_lda[m1 == 4, 0])
ld2[4].append(XX_lda[m1 == 4, 1])
ld3[4].append(XX_lda[m1 == 4, 2])
ld1[5].append(XX_lda[m1 == 5, 0])
ld2[5].append(XX_lda[m1 == 5, 1])
ld3[5].append(XX_lda[m1 == 5, 2])
ld1[6].append(XX_lda[m1 == 6, 0])
ld2[6].append(XX_lda[m1 == 6, 1])
ld3[6].append(XX_lda[m1 == 6, 2])
ld1[7].append(XX_lda[m1 == 7, 0])
ld2[7].append(XX_lda[m1 == 7, 1])
ld3[7].append(XX_lda[m1 == 7, 2])
ld1[8].append(XX_lda[m1 == 8, 0])
ld2[8].append(XX_lda[m1 == 8, 1])
ld3[8].append(XX_lda[m1 == 8, 2])
ld1[9].append(XX_lda[m1 == 9, 0])
ld2[9].append(XX_lda[m1 == 9, 1])
ld3[9].append(XX_lda[m1 == 9, 2])
ld1[10].append(XX_lda[m1 == 10, 0])
ld2[10].append(XX_lda[m1 == 10, 1])
ld3[10].append(XX_lda[m1 == 10, 2])
#waights
...
for x1, y1 in zip(ld1[0], ld2[0]):
    ...
    ax1.scatter(x11, y11, c=z, s=50, zorder=10, alpha=0.1, edgecolor='')
...
ax1.scatter(ld1[1], ld2[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', alpha=0.3, edgecolor='black', zorder=134.0, label='Obs. hPNe')
ax1.scatter(ld1[3], ld2[3], c=sns.xkcd_rgb['pale yellow'], alpha=0.3, s=90, marker='o', edgecolor='black', zorder=3.0, label='SDSS CVs')
ax1.scatter(ld1[5], ld2[5],  c= "mediumaquamarine", alpha=0.3, s=90, edgecolor='black',  marker='D', label='SDSS QSOs')
ax1.scatter(ld1[10], ld2[10],  c= "goldenrod", alpha=0.3, s=120, marker='^', edgecolor='black', label='SDSS SFGs')
ax1.scatter(ld1[2], ld2[2],  c= "red", alpha=0.3, s=90, marker='s', edgecolor='black', zorder=3.0, label='Obs SySt')
#ax1.scatter(ld1[3], ld2[3],  c= "red", alpha=0.8, s=120, marker='^', edgecolor='black', zorder=3.0, label='IPHAS SySt')
ax1.scatter(ld1[4], ld2[4],  c= "gray", alpha=0.3, s=90, marker='D', edgecolor='black', zorder=133.0, label='Obs. HII regions in NGC 55')
ax1.scatter(ld1[6], ld2[6],  c= "lightsalmon", alpha=0.3, s=150, marker='*', edgecolor='black', label='Obs. YSOs')
ax1.scatter(ld1[9], ld2[9],  c= sns.xkcd_rgb["mint green"], alpha=0.3, s=150, marker='*', edgecolor='black', zorder= 113, label='S-PLUS DR1 WDs')
ax1.scatter(ld1[7], ld2[7],  c= sns.xkcd_rgb["cerulean"],  s=700, marker='*', edgecolor='black', zorder= 120, label='Sources selected in J-PLUS DR1')
ax1.scatter(ld1[8], ld2[8],  c= sns.xkcd_rgb["light green"],  s=700, marker='*', edgecolor='black', linewidth='1.7', zorder= 113, label='HASH sources in J/S-PLUS DR1')
...
for x,y in zip(ld1[7], ld2[7]):
    ax1.annotate("2", (x[0], y[0]), alpha=9,  size=21, #PN
                   xytext=(-14.0, -3.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)
    ...
    ax1.annotate("1", (x[2], y[2]), alpha=9, size=21, #candidate
                   xytext=(5, -35.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=180, weight='bold',)
    ax1.annotate("4", (x[3], y[3]), alpha=9, size=21, #2790884
                   xytext=(-5.0, -33.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)

for aa, bb in zip(ld1[7], ld2[7]):
    for a, b, c in zip(label_dr1, aa, bb):
        print(a,b,c)
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'Fig1-JPLUS-LD1-LD2-verif.pdf'
...
for x1, y1 in zip(ld1[0], ld3[0]):
    x11, y11, z = x1[idx], y1[idx], z[idx]
    ax2.scatter(x11, y11, c=z, s=50, zorder=10, alpha=0.1, edgecolor='')
...
ax2.scatter(ld1[1], ld3[1],  color= sns.xkcd_rgb["aqua"], s=130, marker='o', alpha=0.3, edgecolor='black', zorder=134.0, label='Obs. hPNe')
ax2.scatter(ld1[3], ld3[3], c=sns.xkcd_rgb['pale yellow'], alpha=0.3, s=90, marker='o', edgecolor='black', zorder=3.0, label='SDSS CVs')
ax2.scatter(ld1[5], ld3[5],  c= "mediumaquamarine", alpha=0.3, s=90, edgecolor='black',  marker='D', label='SDSS QSOs')
ax2.scatter(ld1[9], ld3[9],  c= "goldenrod", alpha=0.3, s=120, marker='^', edgecolor='black', label='SDSS SFGs')
ax2.scatter(ld1[2], ld3[2],  c= "red", alpha=0.3, s=90, marker='s', edgecolor='black', zorder=3.0, label='Obs SySt')
#ax1.scatter(ld1[3], ld2[3],  c= "red", alpha=0.8, s=120, marker='^', edgecolor='black', zorder=3.0, label='IPHAS SySt')
ax2.scatter(ld1[4], ld3[4],  c= "gray", alpha=0.3, s=90, marker='D', edgecolor='black', zorder=133.0, label='Obs. HII regions in NGC 55')
ax2.scatter(ld1[6], ld3[6],  c= "lightsalmon", alpha=0.3, s=150, marker='*', edgecolor='black', label='Obs. YSOs')
ax2.scatter(ld1[9], ld3[9],  c= sns.xkcd_rgb["mint green"], alpha=0.3, s=150, marker='*', edgecolor='black', zorder= 113, label='S-PLUS DR1 WDs')
ax2.scatter(ld1[7], ld3[7],  c= sns.xkcd_rgb["cerulean"], s=700, marker='*', edgecolor='black', zorder= 113, label='Sources selected in J-PLUS DR1')
...
for x,y in zip(ld1[7], ld3[7]):
    ...
    ax2.annotate("3", (x[1], y[1]), alpha=9, size=21, #LEDA 101538
                   xytext=(10.0, 15.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)
    ax2.annotate("1", (x[2], y[2]), alpha=9, size=21, #candidate
                   xytext=(5, 15.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=180, weight='bold',)
    ax2.annotate("4", (x[3], y[3]), alpha=9, size=21, #2790884
                   xytext=(-5, 15.0), textcoords='offset points', ha='right', va='bottom', bbox=bbox_props, zorder=150,)

for aa, bb in zip(ld1[7], ld3[7]):
    for a, b, c in zip(label_dr1, aa, bb):
        print(a,b,c)
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'Fig2-JPLUS-LD1-LD3-verif.pdf'
file_save = os.path.join(save_path, pltfile)
plt.savefig(file_save)
plt.clf()
