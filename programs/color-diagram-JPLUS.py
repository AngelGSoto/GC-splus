...
errx, erry = [0.738932, 0.11974 ], [3.811793, 0.095063]
...
for file_name2 in file_list2:
    with open(file_name2) as f2:
        data2 = json.load(f2)
        fil1 = data2["J0625_rSDSS"]-1.162
        fil2 = data2["J0660"]-25+21.094 
        fil3 = data2["J0766_iSDSS"]-25+23.260
        diff = fil1 - fil2
        diff0 = fil1 - fil3
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0)
...
for file_name2 in file_list2:
    with open(file_name2) as f2:
        data2 = json.load(f2)
        file1 = data2["J0625_rSDSS"] + 1.09
        file2 = data2["J0660"] + 1.34
        file3 = data2["J0766_iSDSS"] + 1.25
        diff = file1 - file2
        diff0 = file1 - file3
        # d_644_jplus.append(diff)
#         d_768_jplus.append(diff0)
...
(_, caps, _) = ax1.errorbar(d_768_jplus, d_644_jplus, xerr=errx, yerr=erry, marker='s', fmt='ks', markersize=8,)
for cap in caps:
...
plt.annotate(
    ...
    xytext=(4, 0), textcoords='offset points', fontsize='x-small')
...
plt.tight_layout()
plt.savefig('diagram-JPLUS-Viironen.pdf', bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.clf()
######################################################################
#---------------------------------------------------------------------#
######################################################################
...
errx, erry = [0.24, 0.044], [3.304, 0.0437]
#Include de magnitudes from JPLUS images
pattern1 = "JPLUS-data/H4-1-phot/*6pix.json"
file_list1 = glob.glob(pattern1)
for file_name1 in file_list1:
...
ax1 = fig.add_subplot(111)
#ax1.set_xlim(xmin=-1.7,xmax=2.0)
# ax1.set_xlim(xmin=-1.3,xmax=3.5)
# ax1.set_ylim(ymin=-1.8,ymax=6.0)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
#ax1.set_ylim(ymin=-1.8,ymax=5.0)
plt.xlabel('(5034-5265)  -  (8389-8830)', size = 16)
plt.ylabel('(5034-5265) -  (6524-6675)', size = 16)
ax1.scatter(d_768, d_644, c='black', alpha=0.8, s=35, label='Halo PNe')
ax1.scatter(d_768_CNP, d_644_CNP,  c= "yellow", alpha=0.8, marker='o', label='Disk PN')
ax1.scatter(d_768_c, d_644_c, c='purple', alpha=0.8, label='CVs')
ax1.scatter(d_768_L2d0, d_644_L2d0,  c= "orange", alpha=0.8, marker='s', s=5)
...
plt.annotate(
    '', xy=(d_768_L2d0[0]+1.2, d_644_L2d0[0]+1.2), xycoords='data',
    xytext=(d_768_L2d02[0]+1.2, d_644_L2d02[0]+1.2), textcoords='data',
    arrowprops={'arrowstyle': '<-'})
plt.annotate(
    '', xy=(d_768_L2d0[0]+0.7, d_644_L2d0[0]+1.6), xycoords='data',
...
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('diagram-JPLUS-F515.pdf', bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.clf()
###########################################################################
#--------------------------------------------------------------------------#
###########################################################################
...
#Include de magnitudes from JPLUS images
errx, erry = [3.8117998738, 0.095062885333 ], [3.8040943948929997,0.155553061205 ]
pattern1 = "JPLUS-data/H4-1-phot/*6pix.json"
file_list1 = glob.glob(pattern1)
for file_name1 in file_list1:
    with open(file_name1) as f1:
        ...
        fil2 = data1["J0480_gSDSS"]-1.192
        fil3 = data1["J0625_rSDSS"]-1.136 
        diff = fil1 - fil2
        diff0 = fil1 - fil3
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0)
...
for file_name1 in file_list1:
    with open(file_name1) as f1:
        data1 = json.load(f1)
        fil1 = data1["J0660"]-25+21.094 
        fil2 = data1["J0480_gSDSS"]-1.367
        fil3 = data1["J0625_rSDSS"]-1.162 
        diff = fil1 - fil2
        diff0 = fil1 - fil3
        d_644_jplus.append(diff)
        d_768_jplus.append(diff0) 
...
for file_name2 in file_list2:
    with open(file_name2) as f2:
        data2 = json.load(f2)
        file1 = data2["J0660"] + 1.34 
        file2 = data2["J0480_gSDSS"] + 1.23 
        file3 = data2["J0625_rSDSS"] + 1.09
        diff = file1 - file2
        diff0 = file1 - file3
        # d_644_jplus.append(diff)
        # d_768_jplus.append(diff0) 
...
fig = plt.figure(figsize=(7, 6))
ax1 = fig.add_subplot(111)
ax1.set_xlim(xmin=-3.1,xmax=1.0) #right
# #ax1.set_xlim(xmin=-1.0,xmax=3.5)
ax1.set_ylim(ymin=-4.0,ymax=1.0) #right
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
#ax1.set_ylim(ymin=-1.8,ymax=5.0)
plt.xlabel('(6524-6675)  -  r', size = 16)
plt.ylabel('(6524-6675) -  (3874-5625)', size = 16)
ax1.scatter(d_768, d_644, c='black', alpha=0.8, s=35, label='Halo PNe')
ax1.scatter(d_768_CNP, d_644_CNP,  c= "yellow", alpha=0.8, marker='o', label='Disk PN')
ax1.scatter(d_768_c, d_644_c, c='purple', alpha=0.8, label='CVs')
ax1.scatter(d_768_L2d0, d_644_L2d0,  c= "orange", alpha=0.8, marker='s', s=5)
...
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('diagram-JPLUS-F660.pdf', bbox_extra_artists=(lgd,), bbox_inches='tight')
