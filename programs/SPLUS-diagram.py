...
plt.xlabel(r'rSDSS - iSDSS', fontsize= 16)
plt.ylabel(r'rSDSS - J0660', fontsize= 16)
...
ax1.scatter(B1[129], A1[129],  c= "red", alpha=0.8, marker='s', label='Obs. MW SySts ')
#ax1.scatter(B1[72], A1[72],  c= "red", alpha=0.8, marker='D', label='Symbiotics in NGC 55')
ax1.scatter(B1[130], A1[130],  c= "red", alpha=0.8, s=38, marker='^', label='IPHAS SySts')
...
plt.tight_layout()
plt.savefig('luis-SPLUS-Viironen.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.clf()
...
#ax1.set_xlim(xmin=-1.7,xmax=2.0)
ax2.set_xlim(xmin=-1.2,xmax=3.5)
ax2.set_ylim(ymin=-1.0,ymax=5.3)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
...
ax2.scatter(B1[129], A1[129],  c= "red", alpha=0.8, marker='s', label='Obs. MW SySts ')
...
ax2.legend(scatterpoints=1, ncol=2, fontsize=8.0, **lgd_kws)
ax2.grid()
#lgd = ax2.legend(loc='center right', bbox_to_anchor=(1.27, 0.5), fontsize=7.5, **lgd_kws)
#ax2.grid(which='minor', lw=0.5)
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('luis-SPLUS-F515-F861.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.clf()
...
#ax1.set_xlim(xmin=-1.7,xmax=2.0)
ax3.set_xlim(xmin=-2.7,xmax=1.1)
ax3.set_ylim(ymin=-4.0,ymax=1.0)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
...
ax3.scatter(B1[129], A1[129],  c= "red", alpha=0.8, marker='s', label='Obs. MW SySts ')
#ax3.scatter(B1[72], A1[72],  c= "red", alpha=0.8, marker='D', label='Symbiotics in NGC 55')
ax3.scatter(B1[130], A1[130],  c= "red", alpha=0.8, s=38, marker='^', label='IPHAS SySts')
...
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('luis-SPLUS-H-r.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
...
ax4.minorticks_on()
#ax1.grid(which='minor')#, lw=0.3)
ax4.legend(scatterpoints=1, ncol=2, fontsize=8.0, loc = 'upper left', **lgd_kws)
ax4.grid()
#lgd = ax4.legend(loc='center right', bbox_to_anchor=(1.27, 0.5), fontsize=7.5, **lgd_kws)
#ax4.grid(which='minor', lw=0.5)
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('luis-SPLUS-u-F861.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
#plt.clf()
...
for file_name in file_list:
    with open(file_name) as f:
        ...
        if data['id'].endswith("1-HPNe"):
            ...
            label.append("MWC 574")
        plot_mag("F910_zSDSS", "F660", "F770_iSDSS")
...
#ax1.set_xlim(xmin=-1.7,xmax=2.0)
ax5.set_xlim(xmin=-1.6,xmax=0.4)
ax5.set_ylim(ymin=-2.3,ymax=4.5)
plt.tick_params(axis='x', labelsize=15) 
plt.tick_params(axis='y', labelsize=15)
...
#sns.despine(bottom=True)
plt.tight_layout()
plt.savefig('luis-SPLUS-z-H.pdf')#,  bbox_extra_artists=(lgd,), bbox_inches='tight')
