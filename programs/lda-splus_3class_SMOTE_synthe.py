...
test_pred1 = lda2.predict(X_test)

cm = confusion_matrix(y_test, test_pred1)
print('Accuracy score for Testing Dataset SMOTE = ', accuracy_score(test_pred1, y_test))
print('Precision score for Testing Dataset SMOTE = ', precision_score(test_pred1, y_test, average="macro"))
print('Confusion matrix = ', cm)
######################################################################################3
...
pltfile = 'Fig1-SPLUS18-LD1-LD2-SMOTE.jpg'
